...
namespace TerrainGenerator
{
    public class ChunkCache
    {
        ...
        //Dictionaries of all the chunks
        ...
        public void Update()
        {
            //Look through each list, and and delete any chunks not created
        ...
        {
            //grab a list of all the chunks pending removal
            var chunksToRemove = ChunksToRemove.ToList();

            //Try to remove chunks from there respective lists
            foreach (var chunkPosition in chunksToRemove)
            {
                //if its a requested chunk
                ...
                //else it is just in the chunks to remove list
